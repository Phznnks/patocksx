...
Proxy.addInterface("vrp_garages",src)
		...
		if cooldown < 1 then
			if not IsPedInAnyVehicle(ped) then
				...
				for k,v in pairs(spawn) do
					...
					if dist <= 10.5 then
						likizao = 4	
						DrawMarker(36, v.x,v.y,v.z-0.7,0,0,0,0,0,0,0.6,0.6,0.7,255, 255, 255,255,0,0,0,1)
						DrawMarker(27, v.x,v.y,v.z-1,0,0,0,0,0,0,0.8,0.8,0.9,38, 255, 255,255,0,0,0,1)
						if dist <= 1 then
