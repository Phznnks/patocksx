		...
		if GetEntityHealth(ped) <= 101 and deathtimer >= 0 then
			if not nocauteado then
				...
				if deathtimer > 0 then
					drawTxt("VOCÊ DESMAIOU, AGUARDE ~r~"..deathtimer.." ~w~SEGUNDOS",4,0.5,0.93,0.50,255,255,255,255)
				else
					drawTxt("PRESSIONE ~r~E ~w~PARA IR AO HOSPITAL",4,0.5,0.84,0.5,255,255,255,255)
				end
