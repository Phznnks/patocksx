...
cfg.webhookPegarDrop = "" -- Webhook de pegar o drop do chao
cfg.webhookEnviarItem = "" -- Webhook de enviar item para a pessoa proxima
cfg.webhookDroparItem = "" -- Webhook de dropar item no chao
cfg.webhookDescartarItem = "" -- Webhook de descartar item

cfg.webhookCfgIcon = "https://i.imgur.com/6UJQDZJ.png"
cfg.webhookCfgColor = 7419530

-- INVENTÁRIO / INVENTORY

cfg.enableKeybind = true -- Habilitar a keybind por slot ( clicar na tecla e usar o item )

cfg.enableEffectOpenNui = true -- Habilitar o blur ao abrir o inventario
cfg.openNuiEffect = function() -- Caso você queira por algum outro tipo de efeito só colocar no campo abaixo
	-- StartScreenEffect("MenuMGSelectionIn", 0, true)
	TransitionToBlurred(1000)
end

cfg.closeNuiEffect = function() -- Aqui você ira remover o efeito que pos acima
	-- StopScreenEffect("MenuMGSelectionIn")
	TransitionFromBlurred(1000)
end

-- PORTA-MALAS / TRUNKCHEST

cfg.itensNaoPortaveisPortaMalas = { -- Itens que nao podem ser colocados no porta-malas
	["dinheirosujo"] = true
}

-- BAÚS / CHEST

cfg.comandoCreateChest = "criarbau" -- Comando para o admin criar baus
cfg.permCreateChest = "manager.permissao" -- Permissao para o admin criar os baus

cfg.comandoDelChest = "delchest" -- Comando para o admin deletar baus
cfg.permDelChest = "manager.permissao" -- Permissao para o admin deletar os baus

cfg.drawTxtChests = function(v) -- Blip de baú abaixo, para caso você queira editar
	DrawText3D(v.x, v.y, v.z, "PRESSIONE ~p~E~w~ PARA ABRIR O BAÚ: ~p~"..string.upper(v.chestname))
end

-- CASAS / HOMES

cfg.permissaoPolicia = "policia.perm" -- Permissao da policia para poder utilizar as funcoes abaixo

cfg.comandoEnterHouse = "enter" -- Comando para comprar casa ou entrar nela
cfg.comandoExitHouse = "exit" -- Comando para sair da casa
cfg.comandoVaultHouse = "vault" -- Comando para abrir o bau da casa
cfg.comandoInvadeHouse = "invade" -- Comando para invadir ( apenas policia )

cfg.comandoHomes = "homes" -- Comando /homes para abrir as opcoes
cfg.homesArgsAdd = "add" -- Comando para adicionar player nas casa como morador ( ex: /homes add 1 NOMEDACASA )
cfg.homesArgsRem = "rem" -- Comando para remover player da casa como morador ( ex: /homes rem 1 NOMEDACASA )
cfg.homesArgsGarage = "garage" -- Comando para adicionar o player para ter acesso a garagem da casa ( ex: /homes garage 1 NOMEDACASA )
cfg.homesArgsList = "list" -- Comando para listar todas as casas disponiveis para compra
cfg.homesArgsCheck = "check" -- Comando para checar a casa
cfg.homesArgsTransfer = "transfer" -- Comando para transferir a casa
cfg.homesArgsTax = "tax" -- Comando para pagar a taxa da casa

cfg.comandoOutfit = "outfit" -- Comnado /outfit
cfg.outfitArgsSave = "save" -- Salvar preset de roupa na casa
cfg.outfitArgsRem = "rem" -- Remover preset de roupa salvo
cfg.outfitArgsApply = "apply" -- Aplicar preset de roupa

-- LOJAS / SHOPS

cfg.drawTxtShops = function(v) -- Blip das lojas, para caso você queira editar
	DrawText3D(v[1], v[2], v[3], "~p~E~w~  ABRIR: ~g~"..string.upper(v[4]))
end

-- CRIAÇÕES / CRAFTING

cfg.drawTxtCrafting = function(v) -- Blip do crafting para caso você queira editar
	DrawText3D(v[1], v[2], v[3], "~g~E~w~  "..string.upper(v[5]).."")
end

-- REVISTAR / INSPECT

cfg.comandoRevistar = "revistar" -- Comando para revistar o player ( o player tem q aceitar )

cfg.comandoRevAdm = "revistar2" -- Comando para o admin revistar o player sem que ele saiba
cfg.permRevAdm = "manager.permissao" -- Permissao do admin para revistar o player

cfg.enableCarryInspect = false -- Quando revistar, ele ira carregar o player ( deixa false, pois pode ocorrer de bugar os players )
...
cfg.craftLocs = { -- Coordenadas, NomeDaArray, TextoQueVaiAparecer ( isso serve para criar mais crafts )
    { 1402.23,1139.88,109.75,"Armamentos","FABRICAR ~p~ARMAMENTOS" }, -- Triade
    { -2675.47,1326.3,140.89,"Armamentos","FABRICAR ~p~ARMAMENTOS" }, -- Mafia

    { 1243.27,1869.51,78.97,"Contrabando","COMPRAR ~p~ITENS ILEGAIS" }
}

cfg.craftConfig = { -- Abaixo vocês podem criar seus crafts
	["Armamentos"] = {
		["perm"] = "armamentos.craft",
		["list"] = {
			-- Armamentos --
			["WEAPON_PISTOL_MK2"] = {
				["amount"] = 1,
...
cfg.shopsLocs = { -- LocalizacoesDasLojas, NomeDaArray
	{ 25.68,-1346.6,29.5,"Departamento" },
	{ 2556.47,382.05,108.63,"Departamento" },
	{ 1163.55,-323.02,69.21,"Departamento" },
	{ -707.31,-913.75,19.22,"Departamento" },
	{ -47.72,-1757.23,29.43,"Departamento" },
	{ 373.89,326.86,103.57,"Departamento" },
	{ -3242.95,1001.28,12.84,"Departamento" },
	{ 1729.3,6415.48,35.04,"Departamento" },
	{ 548.0,2670.35,42.16,"Departamento" },
	{ 1960.69,3741.34,32.35,"Departamento" },
	{ 2677.92,3280.85,55.25,"Departamento" },
	{ 1698.5,4924.09,42.07,"Departamento" },
	{ -1820.82,793.21,138.12,"Departamento" },
	{ 1393.21,3605.26,34.99,"Departamento" },
	{ -3040.14,585.44,7.91,"Departamento" },
	{ 1166.0,2709.45,38.16,"Departamento" },
	...
	{ 4954.49,-5107.84,3.78,"PescaVenda" },

	{ 2521.31,-336.81,101.9,"Arsenal" }
}

cfg.shopsConfig = { -- Nesta array você pode editar o que vai ser comprado na loja ou vendido para ela
	["Departamento"] = {
		["mode"] = "Compra",
		["type"] = "Dinheiro",
		["list"] = {
	...
	["AmmuNation"] = {
		...
		["list"] = {
			...
			["WEAPON_HATCHET"] = 3500,
			["WEAPON_BAT"] = 3500,
			["WEAPON_BATTLEAXE"] = 3500,
			["WEAPON_BOTTLE"] = 3500,
			["WEAPON_CROWBAR"] = 3500,
			["WEAPON_DAGGER"] = 3500,
			["WEAPON_GOLFCLUB"] = 3500,
			["WEAPON_HAMMER"] = 3500,
			["WEAPON_MACHETE"] = 3500,
			["WEAPON_SWITCHBLADE"] = 3500,
			["WEAPON_WRENCH"] = 3500,
			["WEAPON_KNUCKLE"] = 3500,
			["colete"] = 5000
		}
...
cfg.homesLocs = { -- Localizacoes Das Homes ( enter = entrada, exit = saida, vault = loc do bau )
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	["FH01"] = {
...
cfg.homesConfig = { -- NomeDaCasaQueFoiCriadaAcima, ValorDeCompra, MaximoDeUtilizadores, BauDaCasa
-----------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------FORTHILLS-----------------------------------------------------------------------
-----------------------------------------------------------------------------------------------------------------------------------------
	["FH01"] = { 5000000,2,1000 },
